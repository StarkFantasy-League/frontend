...
export default function ArgentinaLeague() {
  ...
  return (
    <div className="w-screen min-h-screen flex items-center justify-center bg-white relative">
      {/* Image as background */}
      <div className="absolute w-full h-full">
        <Image
          src="/argentina-league.png"
          alt="Argentina League Background"
          layout="fill"
          objectFit="cover"
      ...
      {user.isConnected ? (
        <div className="flex z-90 w-full h-full md:leading-[80px] relative flex-col items-center justify-center text-[#FFFFFF] px-1 text-center">
