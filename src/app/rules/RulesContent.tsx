...
export default function RulesContent() {
  return (
     <div className="flex bg-slate-950 pt-9">
          <div className="pl-2 pr-2 lg:pl-[120px] ">
              <section id="1">
                  <div>
                      <h1 className="text-4xl text-center mt-5 font-semibold lg:text-left lg:text-5xl">Game <span className="text-orange-500">Rules</span></h1>
                      <h3 className="text-xl font-semibold text-center mt-1 mb-2 lg:text-left lg:text-3xl lg:pt-[120px] lg:pb-7">Introduction</h3>
              ...
              <section id="2">
                  <div>
                      <h1 className="font-semibold text-2xl text-center pt-3 pb-2 lg:text-left lg:text-4xl lg:pt-5">Soccer Rules</h1>
                      <p className="text-center lg:text-left">
                      ...
                      <RulesTableFootball />
                      <div id="3">
                        <h3 className="text-2xl text-center pb-2 lg:text-left lg:text-3xl">Card Punctuation Metrics</h3>
                        <p className="text-center lg:text-left">
                        ...
                        <p className="text-center lg:text-left">In the case of <span className="text-orange-600">red card</span> it will set to 0 the point of the player in that match.</p>
                      </div>
                      <div id="4">
                         <h3 className="text-xl text-center pb-1 pt-3 lg:text-left lg:text-3xl">Additional Rules</h3>
                         <p className="text-center lg:text-left">
                           <p><span className="text-orange-600 font-semibold">Substitues</span>: Bench players <span className="text-orange-600">earn half the points</span>(e.g., a goal <br /> = +5 points instead of 10)</p>
                           <p><span className="text-orange-600 font-semibold">Team Captain</span>: You can select a captain for your team, these player earns <span className="text-orange-600">double point</span>(e.g., a goal = +20 points instead of 10).</p>
                         </p>
                      </div>
                  </div>
              </section>
              <section id="5">
                  <h1 className="font-semibold text-2xl text-center pt-4 pb-2 lg:text-left lg:text-4xl">NBA Rules</h1>
                  <p className="text-center lg:text-left">
                  ...
                  <div>
                      <h3 className="text-xl text-center pb-1 pt-3 lg:text-left lg:text-2xl">Additional Rules</h3>
                      <p className="text-center lg:text-left">
              ...
              <section>
                <div id="6">
                   <h1 className="text-center text-3xl font-semibold py-3 lg:text-left lg:text-4xl">Entry Fee</h1>
                   <p className="text-center lg:text-left ">
                ...
                <div id="7">
                  <h1 className="text-center text-3xl font-semibold py-3 lg:text-left lg:text-4xl">Rewards</h1>
                  <p className="text-center lg:text-left">
                    Each tournament offers different rewards based on the entry fee.
                    <p className="flex ml-7 pb-2">
                  ...
                  <div className="flex  rounded-md ml-1 bg-slate-900 mb-5 mt-2 lg:py-3">
                    ...
                    <p className="ml-1 "><span className="font-semi-bold">Note:</span> Private tournaments (<span className="text-orange-600">Friends League</span>) do not qualify for rewards. Play in <span>Official</span> competitions to  <br /> win!</p>
                  </div>
                </div>
              </section>
          </div>
          <span className="hidden lg:block fixed right-40">
